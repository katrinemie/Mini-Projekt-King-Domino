...
# === Parametre ===
input_folder = 'splitted_dataset/train/cropped'   # Din sti til billeder
template_path = 'opdateret_skærmbillede.png'      # Din kongekrone-template
output_folder = 'outputs_with_crowns'              # Her gemmes resultaterne
